...
class Dog:
    """A simple Dog class to learn OOP
     ...
     favorite_food - the dog's favotite food
     """

    def __init__(self, fur_color="black", name="no name", age = 1, favorite_food = "kibble"):
        """"Initialize a new Dog with fur_color, name, agem and favorite food"""
    ...
    def change_favorite_food(self, new_food):
        ...
        print(f"{self.name} used to love {old_food} and noe loves {self.favorite_food}")
